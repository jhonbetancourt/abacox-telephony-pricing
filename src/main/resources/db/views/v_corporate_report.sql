...
SELECT
    ...
    -- Conditional Origin/Destination Phone Numbers
    CASE
    ...
    oc.name AS origin_country_name, -- <<< NEW FIELD ADDED HERE

    -- Combined Cost Center field
    CASE
