    ...
    public static final String QUERY = """
            SELECT * FROM (
                ...
                SELECT
                    ...
                    parent_sub.name AS regionalName,
                    (
                ...
                LEFT JOIN subdivision parent_sub ON parent_sub.id = sub.parent_subdivision_id
                LEFT JOIN LATERAL (
                    SELECT inv.installation_date, inv.equipment_type_id, inv.inventory_equipment_id
                    FROM inventory inv
                    WHERE inv.employee_id = f.id
