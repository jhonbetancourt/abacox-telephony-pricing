...
public class TrunkRule extends ActivableEntity {
        ...
        @SequenceGenerator(name = "trunk_rule_id_seq", sequenceName = "trunk_rule_id_seq", allocationSize = 1, initialValue = 10000000)
        ...
        @ManyToOne
        @JoinColumn(name = "telephony_type_id", insertable = false, updatable = false, foreignKey = @ForeignKey(name = "fk_trunk_rule_telephony_type"))
        ...
        @ManyToOne
        @JoinColumn(name = "trunk_id", insertable = false, updatable = false, foreignKey = @ForeignKey(name = "fk_trunk_rule_trunk"))
        private Trunk trunk;
        ...
        @ManyToOne
        @JoinColumn(name = "new_operator_id", insertable = false, updatable = false, foreignKey = @ForeignKey(name = "fk_trunk_rule_new_operator"))
        ...
        @ManyToOne
        @JoinColumn(name = "new_telephony_type_id", insertable = false, updatable = false, foreignKey = @ForeignKey(name = "fk_trunk_rule_new_telephony_type"))
        ...
        @ManyToOne
        @JoinColumn(name = "origin_indicator_id", insertable = false, updatable = false, foreignKey = @ForeignKey(name = "fk_trunk_rule_origin_indicator"))
