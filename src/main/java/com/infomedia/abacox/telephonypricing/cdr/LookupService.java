// Already provided in the previous response.
 // Refinements applied:
 // - findIndicatorByNumber: Added LENGTH(ndc) to ORDER BY.
 // - findPbxSpecialRule: Implemented ignore pattern logic.
 // - findSpecialRateValues: Query filters by day flags; hour filtering moved to service layer.
