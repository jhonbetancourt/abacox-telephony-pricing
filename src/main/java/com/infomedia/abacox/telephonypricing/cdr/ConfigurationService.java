// Already provided in the previous response, no significant changes needed here based on the review.
 ...
 public class ConfigurationService {
     ...
     // Cache for internal operators to avoid repeated DB lookups within a request scope if needed elsewhere
     // private Map<Long, Operator> internalOperators = new HashMap<>(); // Removed, handled by LookupService cache
     ...
     public Optional<TelephonyType> getTelephonyTypeById(Long id) {
         // Use repository for simple ID lookups if preferred, or keep in LookupService
     ...
     public Optional<Operator> getOperatorById(Long id) {
         // Use repository for simple ID lookups if preferred
