...
public class SpecialRateValueService extends CrudService<SpecialRateValue, Long, SpecialRateValueRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<SpecialRateValue> specification, Pageable pageable, Map<String, String> alternativeHeaders, Set<String> excludeColumns) {
