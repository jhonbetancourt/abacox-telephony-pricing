...
public class TrunkRuleService extends CrudService<TrunkRule, Long, TrunkRuleRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<TrunkRule> specification, Pageable pageable, Map<String, String> alternativeHeaders, Set<String> excludeColumns) {
