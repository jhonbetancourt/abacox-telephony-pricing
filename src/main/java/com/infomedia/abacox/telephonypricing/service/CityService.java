...
public class CityService extends CrudService<City, Long, CityRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<City> specification, Pageable pageable, Map<String, String> alternativeHeaders, Set<String> excludeColumns) {
