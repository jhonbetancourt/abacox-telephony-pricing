...
import com.infomedia.abacox.telephonypricing.db.repository.SeriesRepository;
...
@Service
public class SeriesService extends SliceableCrudService<Series, Long, SeriesRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<Series> specification, Pageable pageable, ExcelGeneratorBuilder builder) {
        Slice<Series> collection = findAsSlice(specification, pageable);
       try {
