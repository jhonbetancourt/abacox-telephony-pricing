...
public class JobPositionService extends CrudService<JobPosition, Long, JobPositionRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<JobPosition> specification, Pageable pageable, Map<String, String> alternativeHeaders, Set<String> excludeColumns) {
