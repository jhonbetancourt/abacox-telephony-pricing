...
public class SubdivisionManagerService extends CrudService<SubdivisionManager, Long, SubdivisionManagerRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<SubdivisionManager> specification, Pageable pageable, Map<String, String> alternativeHeaders, Set<String> excludeColumns) {
