...
public class OperatorService extends CrudService<Operator, Long, OperatorRepository> {
    ...
    public ByteArrayResource exportExcel(Specification<Operator> specification, Pageable pageable, Map<String, String> alternativeHeaders, Set<String> excludeColumns) {
