...
public class InventoryController {
    ...
    public ResponseEntity<Resource> exportExcel(@Parameter(hidden = true) @Filter Specification<Inventory> spec,
            @Parameter(hidden = true) Pageable pageable,
            @ParameterObject FilterRequest filterRequest,
            @ParameterObject ExcelRequest excelRequest) {
        ByteArrayResource resource = inventoryService.exportExcel(spec, pageable, excelRequest.toExcelGeneratorBuilder());
